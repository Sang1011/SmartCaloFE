      ...
      <View style={styles.innerContainer}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.row}>
            ...
            <Text style={[styles.value, globalStyles.medium]}>Nam</Text>
          </View>
          <View style={styles.row}>
            <Text style={[styles.label, globalStyles.regular]}>Chiều cao</Text>
            <Text style={[styles.value, globalStyles.medium]}>190 cm</Text>
          </View>
          <View style={styles.row}>
            <Text style={[styles.label, globalStyles.regular]}>Ngày sinh</Text>
            <Text style={[styles.value, globalStyles.medium]}>15/04/2004</Text>
          </View>
        </View>
